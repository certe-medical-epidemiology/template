...
This is a Certe R package for `[here the description]`.

You can read the [manual with explanation about its functions here](https://certe-medical-epidemiology.github.io/???/reference).
